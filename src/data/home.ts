export const homeContent = {
  hero: {
    ...
    imageAlt:
      "Dra. Aline Bellissimo em composição institucional da Clínica Bellissimo",
    images: {
      desktop: {
        src: "/images/hero/bellissimo-hero-desktop.webp",
        width: 1672,
        height: 941,
      },
      mobile: {
        src: "/images/hero/bellissimo-hero-mobile.webp",
        width: 941,
        height: 1672,
      },
    },
